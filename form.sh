...
convert \
    ...
    -fill blue \
    -gravity center \
    -draw "text 0,0 '$(cat /usr/lib/cgi-bin/acak201.txt)'" \
    image.png
convert image.png -background white -wave 4x55 image.png
sudo cp image.png /home/serverjogja
cat <<EOT
<!DOCTYPE html>
<html>
<head>
    <title>Pendaftaran VPS - securityhub.id</title>
    ...
    <div class="container">
        <div class="row">
            <div class="offset-1 col-10 mt-4">
                <h3 style="text-align: center;">Pendaftaran VPS - Support PHP, MySQL & Wordpress (Docker Container)</h3>
<br>
                ...
                <table class="table">
                    <tr>
                        ...
                        <td>Nama domain : </td>
                        <td>
                             <input type="text" name="namedomain" pattern="^[a-zA-Z0-9.@]+$" title="Hanya format domain" class="form-control">
                        </td>
                    </tr>
                   ...
                   <tr>
                        ...
                        <td>
                            <input type="text" name="name" pattern="^[a-z0-9]+$"  title="Hanya mendukung huruf kecil dan angka.">.tugaspkl.my.id
                        </td>
                    </tr>
