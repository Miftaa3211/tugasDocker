...
# Simpan env vars ke /etc/environment agar PHP bisa membacanya
echo "CF_ZONE=$zoneid" >> /etc/environment
echo "CF_EMAIL=$email" >> /etc/environment
echo "CF_KEY=$globalapikey" >> /etc/environment
